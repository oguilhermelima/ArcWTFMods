...
## P.S
1. This mods try to adapt the look from Windows version of Arc Browser
2. This mods has some conflicts with split views extensions and Floop browser
...
3. Check 'Root Directory' and click 'Open Folder'/'Show in Finder'
4. Create a new folder 'chrome'
5. Extract the downloaded file inside 'chrome' folder (Check if all files are in the chrome folder root). 
...
| Behavior                                               |                         Flag                         |  Value |
|:-------------------------------------------------------|:----------------------------------------------------:|-------:|
| Extend sidebar size                                    |              `uc.tweak.longer-sidebar`               |   true |
